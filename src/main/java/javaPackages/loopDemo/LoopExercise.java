...
// with the help of gitbash ... I push the codes git(local) to github (central Repo)
// what is loop: repeating a block of code


public void loopintroductiond(){
   // print 1-10
...
//    System.out.println(10);
 ...
 /*1. While loop
   ...
   */
    ...
    public void arr(){
        String [] studentName= {"Dharti","lota","Sadia","Fayza"};// ArrayData
